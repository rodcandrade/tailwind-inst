...
function Contact() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Contate-nos</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Lorem ipsum dolor sit, amet consectetura adipisicing elit. Perspiciatis reprehenderit quidem cumque, aperiam iure libero suscipit vero. Ab quisquam culpa exercitationem commodi quis sunt. Provident iste officiis esse laudantium pariatur!.</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <button type="submit" class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Enviar</button>
        </div>
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
          <a class="text-blue-400"></a>
          <p class="leading-normal my-5">Santa Rosa
            <br/>RS, Brasil
          </p>
