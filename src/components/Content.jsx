  ...
  return (
    ...
    <div class="container px-6 py-28 mx-auto ">
        <div class="flex items-center justify-between">
            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Posts recentes </h1>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
            <div>
                ...
                <div class="mt-8">
                    <span class="text-blue-500 uppercase">categoria</span>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Fevereiro 1, 2022</p>
                        </div>

                        <a href="#" class="inline-block text-blue-500 underline hover:text-blue-400">Leia mais</a>
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Fevereiro 6, 2022</p>
                        </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Fevereiro 19, 2022</p>
                        </div>
